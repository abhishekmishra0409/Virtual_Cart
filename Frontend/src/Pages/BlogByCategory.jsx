...
import { getBlogsByCategory } from '../features/Blog/BlogSlice.js';
import {useParams} from "react-router-dom";

export const BlogByCategory = () => {
    ...
    const currentBlogs = blogsByCategory.slice(indexOfFirstBlog, indexOfLastBlog);

    const totalPages = Math.ceil(blogsByCategory.length / blogsPerPage);
                                ...
                                <div className="row">
                                    ...
                                    <div
                                        ...
                                        <span className="font-sm color-gray-900 font-medium me-3">
                                            Showing {indexOfFirstBlog + 1}–{Math.min(indexOfLastBlog, blogsByCategory.length)} of {blogsByCategory.length} results
                                        </span>
