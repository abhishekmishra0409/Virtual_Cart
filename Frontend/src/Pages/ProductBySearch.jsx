...
export const ProductBySearch = () => {
    ...
    const { results, isLoading, isError } = useSelector((state) => state.products);
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-xl-10 col-lg-9 mb-10 text-lg-end text-center d-flex justify-content-end align-items-center">
                                        <span className="font-sm color-gray-900 font-medium me-3">
                                            Showing {indexOfFirstProduct + 1}–{Math.min(indexOfLastProduct, results.length)} of {results.length} results
                                        </span>
                                        ...
                                        {/*            id="dropdownSort"*/}
                                        {/*        >*/}
                                        {/*            <span className="font-sm color-gray-900 font-medium me-2">Latest results</span>*/}
                                        {/*        </Dropdown.Toggle>*/}
                                        {/*        <Dropdown.Menu>*/}
                                        {/*            <Dropdown.Item href="#/action-1" active>Latest results</Dropdown.Item>*/}
                                        {/*            <Dropdown.Item href="#/action-2">Oldest results</Dropdown.Item>*/}
                                        {/*            <Dropdown.Item href="#/action-3">Top-rated results</Dropdown.Item>*/}
                                        {/*        </Dropdown.Menu>*/}
                                        {/*    </Dropdown>*/}
                                        {/*</div>*/}
