                            ...
                            <div className="box-filters mt-0 pb-5 border-bottom">
                                <div className="row">
                                    ...
                                    <div className="col-xl-10 col-lg-9 mb-10 text-lg-end text-center d-flex justify-content-end align-items-center">
                                        ...
                                        {/*            id="dropdownSort"*/}
                                        {/*        >*/}
                                        {/*            <span className="font-sm color-gray-900 font-medium me-2">Latest products</span>*/}
                                        {/*        </Dropdown.Toggle>*/}
                                        {/*        <Dropdown.Menu>*/}
                                        {/*            <Dropdown.Item href="#/action-1" active>Latest products</Dropdown.Item>*/}
                                        {/*            <Dropdown.Item href="#/action-2">Oldest products</Dropdown.Item>*/}
                                        {/*            <Dropdown.Item href="#/action-3">Top-rated products</Dropdown.Item>*/}
                                        {/*        </Dropdown.Menu>*/}
                                        {/*    </Dropdown>*/}
                                        {/*</div>*/}
